...
class VecDB:
    ...
    def retrieve(self, query: Annotated[np.ndarray, (1, DIMENSION)], top_k=5, n_probes=None):
        ...
        codebooks = self._get_pq_codebooks()https://github.com/Mohamed-Ashraf273/vec_db/pull/14/conflict?name=vec_db.py&ancestor_oid=56cfb01746659ac146413fb0d8919a240e152d99&base_oid=0f542dc0ab310d09bdb19c622c2eee1f7edcfd4c&head_oid=1596554d95383255de2727d4947be449f16815b3
